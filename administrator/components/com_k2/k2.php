...
// CSS
$document->addStyleSheet(JURI::root(true).'/media/k2/assets/css/k2.css?v=2.6.3');
...
$document->addScript(JURI::root(true).'/media/k2/assets/js/k2.js?v=2.6.3');
...
<div id="k2AdminFooter">
	<a target="_blank" href="http://getk2.org/">K2 v2.6.3</a> | Copyright &copy; 2006-<?php echo date('Y'); ?> <a target="_blank" href="http://www.joomlaworks.net/">JoomlaWorks Ltd.</a>
</div>
<?php endif;
