<?php
/**
 * @version		$Id: categorieslatest.php 1812 2013-01-14 18:45:06Z lefteris.kavadas $
 * @package		K2
...
class K2ElementCategoriesLatest extends K2Element
{
    ...
    function fetchElement($name, $value, &$node, $control_name)
    {
        ...
        $document->addStyleSheet(JURI::root(true).'/media/k2/assets/css/k2.modules.css?v=2.6.3');
