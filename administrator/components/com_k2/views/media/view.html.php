...
class K2ViewMedia extends K2View
{
    ...
    function display($tpl = null)
    {
        ...
        $document->addStyleSheet(JURI::root(true).'/media/k2/assets/css/theme.css?v=2.6.3');
        $document->addStyleSheet(JURI::root(true).'/media/k2/assets/css/elfinder.min.css?v=2.6.3');
