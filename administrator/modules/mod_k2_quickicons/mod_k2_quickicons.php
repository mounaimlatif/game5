<?php
/**
 * @version		$Id: mod_k2_quickicons.php 1812 2013-01-14 18:45:06Z lefteris.kavadas $
 * @package		K2
...
if ($modCSSStyling)
	$document->addStyleSheet(JURI::base(true).'/modules/'.$mod_name.'/tmpl/css/style.css?v=2.6.3');
