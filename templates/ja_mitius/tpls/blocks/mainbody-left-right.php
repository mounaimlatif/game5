...
<?php
  ...
  $layout_config = json_decode ('{  
    "two_sidebars": {
      ...
      "wide"    : [],
      "xtablet" : [ "span4 spanfirst"         , "span4"             , "span4"               , "span8"           ],
      "tablet"  : [ "span6"        , "span6 spanfirst"  , "span12"               , "span12"           ]
    },
    "one_sidebar": {
      ...
      <div class="ja-sidebar <?php echo $this->getClass($layout, $col) ?>" <?php echo $this->getData ($layout, $col++) ?>>
        ...
        <div class="row">
          ...
          <div class="ja-sidebar ja-sidebar-1 <?php echo $this->getClass($layout, $col) ?><?php $this->_c($sidebar1)?>" <?php echo $this->getData ($layout, $col++) ?>>
             <div class="main-siderbar1"><jdoc:include type="modules" name="<?php $this->_p($sidebar1) ?>" style="T3Xhtml" /> </div>
          </div>
          <!-- //SIDEBAR 1 -->
          <?php endif ?>
          ...
          <div class="ja-sidebar ja-sidebar-2 <?php echo $this->getClass($layout, $col) ?><?php $this->_c($sidebar2)?>" <?php echo $this->getData ($layout, $col++) ?>>
             <div class="main-siderbar1"><jdoc:include type="modules" name="<?php $this->_p($sidebar2) ?>" style="T3Xhtml" /></div>
          </div>
          <!-- //SIDEBAR 2 -->
          <?php endif ?>
        </div>
