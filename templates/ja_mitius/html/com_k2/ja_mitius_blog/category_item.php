...
<div class="catItemBlog catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="item-meta">
    ...
    <span class="catItemHitsBlock">
      <strong class="catItemHits"><?php echo JText::_('K2_READ'); ?></strong>
    ...
    <div class="catItemRatingBlock">
      <strong><?php echo JText::_('K2_RATE_THIS_ITEM'); ?></strong>
  ...
  <div class="catItemBody">
      ...
      <a class="video" href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">Video</a>
      <?php endif; ?>
