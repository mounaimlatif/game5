...
<div id="k2Container" class="itemView itemViewBlog<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="item-meta">
    ...
    <?php if($this->item->params->get('itemHits')): ?>
      <!-- Item Hits -->
      <span class="itemHits">
        <strong><?php echo JText::_('K2_READ'); ?></strong>
	...
	<?php if($this->item->params->get('itemCommentsAnchor') && $this->item->params->get('itemComments') && ( ($this->item->params->get('comments') == '2' && !$this->user->guest) || ($this->item->params->get('comments') == '1')) ): ?>
			...
			<span>
			<strong><?php echo JText::_('K2_COMMENT'); ?></strong>
        ...
        <div class="comment-wrap">
          <span class="arrow">&nbsp;</span>
            ...
            <span class="commentLink">
    		    	...
    		    	<strong>Write on: </strong><?php echo JHTML::_('date', $comment->commentDate, JText::_('K2_DATE_FORMAT_LC')); ?>
    		    </span>

    		    <span class="commentAuthorName">
    			    <strong><?php echo JText::_('K2_POSTED_BY'); ?></strong>
