			...
			<form id="member-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=registration.register'); ?>" method="post" class="form-validate">
				...
				<?php endif;?>
					<dl>
							...
							<dt>
								<label title="Password::Enter your password" class="hasTip required" for="jform_password1" id="jform_password1-lbl"><?php echo JText::_( 'JGLOBAL_PASSWORD' ); ?>:</label><em>*</em></dt>
						<dd>
							<input type="password" size="30" class="validate-password required" value="" id="jform_password1" name="jform[password1]" />
						</dd>
						<dt>
							<label title="Password::Enter your confirm password" class="hasTip required" for="jform_password2" id="jform_password2-lbl"><?php echo JText::_( 'JGLOBAL_REPASSWORD' ); ?>:</label><em>*</em></dt>
						<dd>
							<input type="password" size="30" class="validate-password required" value="" id="jform_password2" name="jform[password2]" />
						</dd>
						<dt>
							<label title="Email::Enter your email" class="hasTip required" for="jform_email1" id="jform_email1-lbl"><?php echo JText::_( 'JAEMAIL' ); ?>:</label><em>*</em></dt>
						<dd>
							<input type="text" size="30" class="validate-email required" value="" id="jform_email1" name="jform[email1]" />
						</dd>
						<dt>
							<label title="Email::Enter your confirm email" class="hasTip required" for="jform_email2" id="jform_email2-lbl"><?php echo JText::_( 'JACONFIRM_EMAIL_ADDRESS'); ?>:</label><em>*</em></dt>
						<dd>
